...
def _stamp_transient_elements_impl(
    ...
    Shared by native compact-model transient kernels. ``a0/a1/a2`` are the
    dQ/dt discretization coefficients applied to
...
def _bsim4_transient_grid_impl(
    ...
    for t_idx in range(1, count):
        ...
        for _ in range(newton_maxit):
            ...
            _stamp_transient_elements_impl(
                F, Aflat, X, input_now, a0, a1, a2, vab1, vab2,
...
def _pac_linearize_orbit_gate1_impl(
    ...
    # node retained -- the numba twin of _reference_pac_linearization (charge_caps
