...
/*
 * CircuitOpt extension: expose the final uncorrelated physical-source
 * densities before any circuit-level transfer function is applied.
 */
extern void CircuitOptBsim4NoiseSource(
              ...
              {  case N_OPEN:
                 ...
                 case N_CALC:
                      ...
                      {  case N_DENS:
                              ...
                              CircuitOptBsim4NoiseSource(
                                  BSIM4v5RDNOIZ, here->BSIM4v5dNodePrime,
                                  here->BSIM4v5dNode,
                                  noizDens[BSIM4v5RDNOIZ]);
                              CircuitOptBsim4NoiseSource(
                                  BSIM4v5RSNOIZ, here->BSIM4v5sNodePrime,
                                  here->BSIM4v5sNode,
                                  noizDens[BSIM4v5RSNOIZ]);
                              CircuitOptBsim4NoiseSource(
                                  BSIM4v5RGNOIZ, here->BSIM4v5gNodePrime,
                                  here->BSIM4v5gNodeExt,
                                  noizDens[BSIM4v5RGNOIZ]);
                              CircuitOptBsim4NoiseSource(
                                  BSIM4v5IDNOIZ, here->BSIM4v5dNodePrime,
                                  here->BSIM4v5sNodePrime,
                                  noizDens[BSIM4v5IDNOIZ]);
                              CircuitOptBsim4NoiseSource(
                                  BSIM4v5FLNOIZ, here->BSIM4v5dNodePrime,
                                  here->BSIM4v5sNodePrime,
                                  noizDens[BSIM4v5FLNOIZ]);
                              CircuitOptBsim4NoiseSource(
                                  BSIM4v5IGSNOIZ, here->BSIM4v5gNodePrime,
                                  here->BSIM4v5sNodePrime,
                                  noizDens[BSIM4v5IGSNOIZ]);
                              CircuitOptBsim4NoiseSource(
                                  BSIM4v5IGDNOIZ, here->BSIM4v5gNodePrime,
                                  here->BSIM4v5dNodePrime,
                                  noizDens[BSIM4v5IGDNOIZ]);
                              CircuitOptBsim4NoiseSource(
                                  BSIM4v5IGBNOIZ, here->BSIM4v5gNodePrime,
