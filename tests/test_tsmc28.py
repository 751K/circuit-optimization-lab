...
def _inverter_spec(*, oracle=False):
    ...
    return circuit_from_dict({
        ...
        "models": {
            "MN": {"pdk": prefix, "model": "nmos",
                   "section": "inherit", "bin": "auto"},
            "MP": {"pdk": prefix, "model": "pmos",
...
def test_device_multiplicity_renders_m_parameter(tmp_path, monkeypatch):
    ...
    def render(with_m):
        raw = {
            ...
            "models": {"MN": {"pdk": "tsmc28hpcp_ngspice", "model": "nmos", "section": "inherit", "bin": "auto"},
                       "MP": {"pdk": "tsmc28hpcp_ngspice", "model": "pmos", "section": "inherit", "bin": "auto", "vb": 0.9}},
