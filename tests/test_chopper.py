...
# (v2.0.0) test_pmos_chopper_pac_gate1_numba_matches_python was removed: it did a
# live numba-vs-Python A/B on the gate1 linearization, both retired with the
# Python reference engine. The gate1 orbit linearization is exercised by the
# rust path in the chopper PAC regressions above and the frozen golden corpus.
